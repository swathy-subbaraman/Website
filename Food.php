...
<link rel="stylesheet" href="C:\Users\CMO\Desktop\Html\W3.CSS">
 ...
 <title>Aashraya: Donate Food!</title>

<h1 style="background-image:violet">
...
<style>
  ...
  <form method="POST" style="background-color:black" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
	  ...
	  <p>We really appreciate your Generosity, But ,May we thank you publicly?</p>
      <div class="checkbox">
	  ...
	  <hr>
	  <p>All set!</p>
	  <p>And now can you tell us, more information about your food donation?</p>
	    <div class="item">
            <label for="zip">Number of persons, you would like to offer food for:<span class="error">*<?php echo $qtyerr?></span><br></label>
            <input id="num" type="number"   name="num" />
          </div>
		  <table>
		  
	  <div class="item">
          <tr><td>  <label for="food">Type Of Food:</label></td>
			<td><select name="food">
			...
			<option value="Sweeets & Pasteries">Sweets & Pastries<option>
			<option value="Snacks & Savouries">Snacks & Savouries<option>
	</select></td></tr>
	<div class="item">
	...
	<div class="item">
      ...
      <textarea id="donation" name="note" rows="3"></textarea>
      </div>
      </fieldset>
      <div class="btn-block">
      <button type="order" name="comm" value="Food" onclick="window.open('file:///C:/xampp/htdocs/Project/Thank%20you.html')">Confirm Donation</button>
      <!--<input type="Submit">-->
	  <br>
      </div>
    </form>
