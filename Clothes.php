...
<link rel="stylesheet" href="C:\Users\CMO\Desktop\Html\W3.CSS">
 ...
 <title>Aashraya: Donate Clothes!</title>

<h1 style="background-image:black">
...
<style>
  ...
  <form method="POST" style="background-color:black" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
	  ...
	  <hr>
	  <p>All set!</p>
	  <p>And now can you tell us, more information about your cloth donation?</p>
	    <div class="item">
            <label for="zip">Number of clothes you would like to offer:</label>
            <input id="num" type="number"   name="num" />
          </div>
		  <table>
		  
	  <div class="item">
      <tr><td>  <label for="food">Type Of Cloth:</label></td>
			<td><select name="food">
			<option value="Baby wear">Babies and Kidswear</option>
			<option value="Women wear">Women wear</option>
			<option value="Mens wear">Mens wear</option>
			<option value="Clothing for Old People">Clothing for Old People</option>
	</select></td></tr>
	<div class="item">
	...
	<div class="item">
      ...
      <div class="btn-block">
      <button type="order" name="comm" value="Clothes" onclick="window.open('file:///C:/xampp/htdocs/Project/Thank%20you.html')">Confirm Donation</button>
      <!--<input type="Submit">-->
	  <br>
      </div>
    </form>
