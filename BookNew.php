...
<style>
  ...
  <form method="POST" style="background-color:black" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
	  ...
	  <p>And now can you tell us, more information about your book donation?</p>
	    <div class="item">
            <label for="zip">Number of books you would like to offer:</label>
	...
	<div class="item">
      ...
      <div class="btn-block">
      <button type="order" name="comm" value="Book" onclick="window.open('file:///C:/xampp/htdocs/Project/Thank%20you.html')">Confirm Donation</button>
      <!--<input type="Submit">-->
	  <br>
      </div>
    </form>
